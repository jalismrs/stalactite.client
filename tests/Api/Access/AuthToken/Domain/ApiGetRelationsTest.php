...
class ApiGetRelationsTest extends EndpointTest
{
    ...
    public function testGetRelations(): void
    {
        ...
        $response = $mockService->getRelations(DataTestModelFactory::getTestableDomain(), 'fake auth token jwt');

        static::assertIsArray($response->getBody());

        static::assertArrayHasKey('users', $response->getBody());
        static::assertIsArray($response->getBody()['users']);
        static::assertArrayHasKey('customers', $response->getBody());
        static::assertIsArray($response->getBody()['customers']);
    ...
    public function testRequestMethodCalledOnce(): void
    {
        ...
        $mockService->getRelations(DataTestModelFactory::getTestableDomain(), 'fake auth token jwt');
    }
}
