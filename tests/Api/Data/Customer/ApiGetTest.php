...
class ApiGetTest extends EndpointTest
{
    ...
    public function testGet(): void
    {
        ...
        $response = $mockService->getCustomer(ModelFactory::getTestableCustomer()->getUid(), 'fake user jwt');
    ...
    public function testRequestMethodCalledOnce(): void
    {
        ...
        $mockService->getCustomer(ModelFactory::getTestableCustomer()->getUid(), 'fake user jwt');
    }
}
