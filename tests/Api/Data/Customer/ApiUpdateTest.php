...
class ApiUpdateTest extends EndpointTest
{
    ...
    public function testThrowLacksUid(): void
    {
        ...
        $mockService->updateCustomer(ModelFactory::getTestableCustomer()->setUid(null), 'fake user jwt');
    }
    ...
    public function testRequestMethodCalledOnce(): void
    {
        ...
        $mockService->updateCustomer(ModelFactory::getTestableCustomer(), 'fake user jwt');
    }
}
