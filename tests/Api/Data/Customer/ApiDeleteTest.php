...
class ApiDeleteTest extends EndpointTest
{
    ...
    public function testThrowLacksUid(): void
    {
        ...
        $mockService->deleteCustomer(ModelFactory::getTestableCustomer()->setUid(null), 'fake user jwt');
    }
    ...
    public function testRequestMethodCalledOnce(): void
    {
        ...
        $mockService->deleteCustomer(ModelFactory::getTestableCustomer(), 'fake user jwt');
    }
}
