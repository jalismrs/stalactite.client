...
class ApiGetTest extends EndpointTest
{
    ...
    public function testGet(): void
    {
        ...
        $response = $mockService->getDomain(ModelFactory::getTestableDomain()->getUid(), 'fake user jwt');
    ...
    public function testRequestMethodCalledOnce(): void
    {
        ...
        $mockService->getDomain(ModelFactory::getTestableDomain()->getUid(), 'fake user jwt');
    }
}
