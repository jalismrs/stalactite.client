...
class ApiGetTest extends EndpointTest
{
    ...
    public function testGet(): void
    {
        ...
        $response = $mockService->getPost(ModelFactory::getTestablePost()->getUid(), 'fake API auth token');
    ...
    public function testRequestMethodCalledOnce(): void
    {
        ...
        $mockService->getPost(ModelFactory::getTestablePost()->getUid(), 'fake API auth token');
    }
}
