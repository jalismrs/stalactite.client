...
class ApiGetTest extends EndpointTest
{
    ...
    public function testGet(): void
    {
        ...
        $response = $mockService->getDomain(ModelFactory::getTestableDomain()->getUid(), 'fake API auth token');
    ...
    public function testRequestMethodCalledOnce(): void
    {
        ...
        $mockService->getDomain(ModelFactory::getTestableDomain()->getUid(), 'fake API auth token');
    }
}
