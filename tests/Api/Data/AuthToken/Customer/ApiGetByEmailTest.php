...
class ApiGetByEmailTest extends EndpointTest
{
    ...
    public function testGetByEmailAndGoogleId(): void
    {
        ...
        $response = $mockService->getByEmail(ModelFactory::getTestableCustomer()->getEmail(), 'fake API auth token');
    ...
    public function testRequestMethodCalledOnce(): void
    {
        ...
        $mockService->getByEmail(ModelFactory::getTestableCustomer()->getEmail(), 'fake API auth token');
    }
}